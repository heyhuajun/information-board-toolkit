...
function validateLayout(layout) {
    const errors = [];
    const warnings = [];
    function validate(component, path = 'layout') {
        // 1. 检查必需字段
        if (!component.type) {
            errors.push({
                path,
    ...
    function validateCard(component, path) {
    ...
    function validateContentCard(component, path) {
        if (!component.title) {
            errors.push({
                path: `${path}.title`,
    ...
    function validateCardGrid(component, path) {
    ...
    function validateCompareTable(component, path) {
    ...
    function validateSection(component, path) {
    ...
    function validateDataSource(component, path) {
        if (!component.source) {
            errors.push({
                path: `${path}.source`,
    ...
    function validateTimeline(component, path) {
    ...
    function validateProgress(component, path) {
    ...
    function validateCollapse(component, path) {
        if (!component.title) {
            errors.push({
                path: `${path}.title`,
    ...
    function validateQuote(component, path) {
        if (!component.content) {
            errors.push({
                path: `${path}.content`,
